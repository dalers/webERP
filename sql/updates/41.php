...
// complex fk relationship in stockserialmoves table requires direct SQL query
// - query generated by phpMyAdmin 5.2.1 and runs correctly in SQL window but seems not in update script TODO FIX
...
//$ErrMsg = __('Re-adding constraint stockserialmoves_ibfk_2 failed');
...
// complex fk relationship in worequirements table requires direct SQL query
// - query runs correctly in update script (or at least after update runs the fk exists and woitems.stockid size is type varchar(64))
...
//$ErrMsg = __('Re-adding constraint worequirements_ibfk_3 failed');
//$Result = DB_query($SQL, $ErrMsg);
